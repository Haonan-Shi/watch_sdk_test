                                             ...
                                             T_HEART_RATE_MEASUREMENT_VALUE heart_rate_measurement_value)
{
    ...
    if (p_heart_rate_measurement_value)
    {
        ...
        memcpy(p_heart_rate_measurement_value, &hrs_heart_rate_measurement_value.flag, 1);
        ...
        {
            memcpy(&p_heart_rate_measurement_value[cur_offset],
                   &hrs_heart_rate_measurement_value.energy_expended, 2);
            cur_offset += 2;
        }
        ...
        {
            memcpy(&p_heart_rate_measurement_value[cur_offset],
                   hrs_heart_rate_measurement_value.p_rr_interval,
