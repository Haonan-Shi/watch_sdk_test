...
typedef enum
{
    ...
    IO_MSG_TYPE_CHATGPT,
    IO_MSG_TYPE_GPIO_BUTTON,
    IO_MSG_TYPE_AUTH_KEY,
    IO_MSG_TYPE_UART_AT_CMD,
} T_IO_MSG_TYPE;
...
typedef enum
{
    ...
    IO_MSG_GPIO_SENSOR_LS8A10049T,
    IO_MSG_GPIO_AW85828_FAULT,
} T_IO_MSG_GPIO;
...
typedef enum
{
    ...
    IO_MSG_START_BLE_ADV            = 0x16,
    IO_MSG_STOP_BLE_ADV             = 0x17,
    IO_MSG_CHATGPT_VOICE_TX_DATA    = 0x18,
    IO_MSG_TYPE_WALKIE_TALKIE       = 0x19,
    IO_MSG_TYPE_MUSICPLAYER         = 0x1A,
    IO_MSG_BT_TOGGLE                = 0x1B,
    IO_MSG_REMOVE_BOND_DEVICE       = 0x1C,
    IO_MSG_TYPE_EVENT_BUS           = 0xFF,
} T_IO_MSG_WRISTBAND;
