...
#define SD_SDHC_PWR_GPIO_PIN    &gpiob 22     /*P0_5*/
...
#define QDEC_PHASE_A_PIN        P3_4
#define QDEC_PHASE_B_PIN        P3_5
#define WIFI_SDHC_CLK_PIN       P5_0
#define WIFI_SDHC_CMD_PIN       P5_1
#define WIFI_SDHC_DATA0_PIN     P5_2
#define WIFI_SDHC_DATA1_PIN     P5_3
#define SD_SDHC_CLK_PIN         P1_2
#define SD_SDHC_CMD_PIN         P1_3
#define SD_SDHC_DATA0_PIN       P1_4
#define SD_SDHC_DATA1_PIN       P1_5
#define SD_SDHC_DATA2_PIN       P3_2
#define SD_SDHC_DATA3_PIN       P3_3
