...
#define LV_MEM_POOL_EXPAND_SIZE 4*1024*1024
...
#define LV_DRAW_SW_SHADOW_CACHE_SIZE 110
...
#define LV_USE_DRAW_PPE_RTL8773G 1

#define LV_USE_DRAW_RTK 1

#define LV_USE_RTK_IDU 1
#define LV_USE_RTK_IDU_HW 1

#define LV_USE_RTK_JPU 1
