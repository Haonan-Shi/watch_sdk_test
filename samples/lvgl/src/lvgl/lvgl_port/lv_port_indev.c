...
static void touchpad_init(void)
{
    // touch_driver_init();  // Zephyr driver auto-initializes; this is non-Zephyr API
...
{
    /*Your code comes here*/
    return get_raw_touch_data(touch_dev).is_press;
}
...
{
    /*Your code comes here*/
    (*x) = get_raw_touch_data(touch_dev).x;
    (*y) = get_raw_touch_data(touch_dev).y;
}
