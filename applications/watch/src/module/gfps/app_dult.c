    ...
    case DULT_OPCODE_INFO_GET_PRODUCT_DATA:
        {
            ...
            rpt.product_data[5] = app_gfps_cfg.gfps_model_id[0];
            rpt.product_data[6] = app_gfps_cfg.gfps_model_id[1];
            rpt.product_data[7] = app_gfps_cfg.gfps_model_id[2];
    ...
    case DULT_OPCODE_INFO_GET_MANUFT_NAME:
        {
            ...
            memcpy(rpt.manufacturer_name, app_gfps_cfg.gfps_company_name,
                   sizeof(app_gfps_cfg.gfps_company_name));
            app_dult_send_indication(conn_handle, cid, service_id, (uint8_t *)&rpt, sizeof(rpt));
        }
        break;
    ...
    case DULT_OPCODE_INFO_GET_MODEL_NAME:
        {
            ...
            memcpy(rpt.model_name, app_gfps_cfg.gfps_device_name,
                   sizeof(app_gfps_cfg.gfps_device_name));
    ...
    case DULT_OPCODE_INFO_GET_ACCESSORY_CATEGORY:
        {
            ...
            rpt.accessory_category[0] = app_gfps_cfg.gfps_device_type;
            app_dult_send_indication(conn_handle, cid, service_id, (uint8_t *)&rpt, sizeof(rpt));
        }
        break;
