...
static P_FUN_AIS_SERVER_APP_CB p_fn_ais_service_cb = NULL;
                              ...
                              uint16_t offset, uint16_t *p_length, uint8_t **pp_value)
{
    ...
    ais_cb_data.service_id = service_id;
    ...
    case FMNA_AIS_PRODUCT_DATA_INDEX:
        {
            ...
            cause = p_fn_ais_service_cb(GATT_MSG_AIS_SERVER_READ, (void *)&ais_cb_data);
...
T_SERVER_ID ais_reg_srv(P_FUN_AIS_SERVER_APP_CB app_cb)
{
    ...
    if (false == gatt_svc_add(&service_id,
                              ...
                              &ais_ble_cbs, NULL))
    {
        APP_PRINT_ERROR0("ais_reg_srv: fail");
        service_id = 0xff;
        return service_id;
    }

    p_fn_ais_service_cb = app_cb;
    return service_id;
}
