...
static P_FUN_FNS_SERVER_APP_CB pfn_fns_data_cb = NULL;
    ...
    *p_write_ind_post_proc = fns_write_post_callback;
    ...
    else
    {
        ...
        else
        {
            ...
            cause = pfn_fns_data_cb(GATT_MSG_FNS_SERVER_WRTIE, &fns_cb_data);
        }
    }
    return cause;
}
                        ...
                        uint16_t cccbits)
{
    ...
    else
    {
        ...
        pfn_fns_data_cb(GATT_MSG_FNS_SERVER_CCCD, &fns_cb_data);
    }
}
...
T_SERVER_ID fns_reg_srv(P_FUN_FNS_SERVER_APP_CB app_cb, P_FUN_GATT_EXT_SEND_DATA_CB send_cb)
{
    ...
    {
        APP_PRINT_ERROR0("fns_reg_srv: fail");
        service_id = 0xff;
        return service_id;
    }

    pfn_fns_data_cb = app_cb;
    return service_id;
}
