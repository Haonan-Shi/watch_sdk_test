...
{
    FMNA_LOG_INFO("fmna_nfc_set_url_key: Set %s", m_nfc_url_key_strings[nfc_url_key]);//TRACE_STRING
...
static void update_nfc_encrypted_serial_number(void)
{
    ...
    fmna_nfc_set_url_key(URL_KEY_SERIAL_NUMBER_ENCRYPTED, p_fmna_encrypted_serial_number_payload);
}
