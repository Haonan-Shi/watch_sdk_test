...
//protocol ver2 used for ppg
#define VER2_HEADER_CRC16_HIGH_BYTE_POS   (2)
#define VER2_HEADER_CRC16_LOW_BYTE_POS    (3)
#define VER2_HEADER_SEQ_ID_HIGH_BYTE_POS  (4)
#define VER2_HEADER_SEQ_ID_LOW_BYTE_POS   (5)
#define VER2_PAYLOAD_LENGTH_HIGH_BYTE_POS (6)         /* L1 payload lengh high byte */
#define VER2_PAYLOAD_LENGTH_LOW_BYTE_POS  (7)
...
typedef enum
{
    ...
    L1SEND_RETURN_RTL87x3B_MAC_ADDR               = 33,
    L1SEND_RETURN_DEVICE_INFO                  = 34,
    L1SEND_RETURN_DAIL_CHANGE                  = 35,
    L1SEND_RETURN_RTL87x3B_STATE                  = 36,
    ...
    L1SEND_RETURN_RTL87x3B_CONNECTED_STATE        = 50,
    L1SEND_RETURN_RTL87x3B_CONN_INFO              = 51,
