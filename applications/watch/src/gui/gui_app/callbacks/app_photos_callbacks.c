...
#include "app_photos_callbacks.h"
#include "../ui/app_photos_ui.h"
...
extern char app_photos_tital_time_text_time_str[10];

// Event callback function implementations

void photo_window_key_0_cb(void *obj, gui_event_t *e)
{
    GUI_UNUSED(obj);
    GUI_UNUSED(e);
    // Check key name
...
void app_photos_tital_time_text_time_update_cb(void *p)
{
    GUI_UNUSED(p);
    ...
    gui_text_content_set((gui_text_t *)app_photos_tital_time_text, app_photos_tital_time_text_time_str,
                         strlen(app_photos_tital_time_text_time_str));
}
