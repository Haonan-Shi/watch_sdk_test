...
extern char hg_time_label_weather_time_str[10];

// Event callback function implementations

void hg_window_weather_top_key_0_cb(void *obj, gui_event_t *e)
{
    GUI_UNUSED(obj);
    GUI_UNUSED(e);
    // Check key name
...
void hg_time_label_weather_time_update_cb(void *p)
{
    GUI_UNUSED(p);
    ...
    gui_text_content_set((gui_text_t *)hg_time_label_weather, hg_time_label_weather_time_str,
                         strlen(hg_time_label_weather_time_str));
}
