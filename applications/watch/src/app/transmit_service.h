...
/** @defgroup TRANSMIT_SVC_CB_MSG
  * @brief TRANSMIT server callback messages
  * @{
  */
#define GATT_MSG_TRANSMIT_SERVER_WRITE          0x00
#define GATT_MSG_TRANSMIT_SERVER_CCCD_UPDATE    0x01
/** @} End of TRANSMIT_SVC_CB_MSG */
...
/**
 * @brief P_FUN_TRANSMIT_SERVER_APP_CB TRANSMIT Server Callback Function Point Definition Function
 *        pointer used in TRANSMIT server module, to send events to specific server module.
 *        The events @ref TRANSMIT_SVC_CB_MSG.
 */
typedef uint16_t (*P_FUN_TRANSMIT_SERVER_APP_CB)(uint8_t type, void *p_data);
