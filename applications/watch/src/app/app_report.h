...
typedef enum
{
    ...
    EVENT_OTA_KEY_CHECK                     = 0x0611,
    EVENT_NORMAL_OTA_CHECK                  = 0x0612,
    ...
    EVENT_PLAYBACK_GET_SD_SPACE_INFO        = 0x068C,
    EVENT_PLAYBACK_GET_FLASH_SPACE_INFO     = 0x068D,
    EVENT_PERMANENT_DELETE_ALL_FILE_BY_FORMAT = 0x068E,
    EVENT_SET_SCENARIO                      = 0x068F,
...
#if CONFIG_RTK_PPG
    EVENT_TRANS_PPG_DATA_CHECK              = 0x3010,
    EVENT_TRANS_GSENSOR_DATA_CHECK          = 0x3011,
    EVENT_TRANS_HRS_DATA_CHECK              = 0x3012,
    EVENT_TRANS_FLASH_DATA_CHECK            = 0X3013,
#endif
