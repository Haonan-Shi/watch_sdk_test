...
#define APP_FINDMY_INFO_ADDR                (APP_BOND_DEVICE_INFO_ADDR + APP_BOND_DEVICE_INFO_SIZE)
...
extern T_APP_AVRCP_FEATURE_CONFIG  app_avrcp_feature_cfg;
