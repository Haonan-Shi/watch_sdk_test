...
typedef enum
{
    ...
    MMI_RECORD_RECORD_AND_PLAY_START = 0xE4,
    MMI_RECORD_RECORD_AND_PLAY_STOP = 0xE5,
...
/**
    ...
    *         User trigger the specific key process, then RTL87x3B would send le advertising data.
