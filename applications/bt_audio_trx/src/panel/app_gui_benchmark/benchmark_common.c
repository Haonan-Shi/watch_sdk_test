...
static benchmark_scenario_cfg_t benchmark_cfg[BENCHMARK_SCENARIO_MAX] =
{
    {false},
    {false},
    {false},
...
{
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_SINGLE_IMG],           &benchmark_cfg[BENCHMARK_SCENARIO_SINGLE_IMG]},
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_SINGLE_IMG_ROTATION],  &benchmark_cfg[BENCHMARK_SCENARIO_SINGLE_IMG_ROTATION]},
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_SINGLE_IMG_CUBE],      &benchmark_cfg[BENCHMARK_SCENARIO_SINGLE_IMG_CUBE]},
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_SINGLE_IMG_REDUCTION], &benchmark_cfg[BENCHMARK_SCENARIO_SINGLE_IMG_REDUCTION]},
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_DOUBLE_IMG],           &benchmark_cfg[BENCHMARK_SCENARIO_DOUBLE_IMG]},
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_CUBE],                 &benchmark_cfg[BENCHMARK_SCENARIO_CUBE]},
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_PERSPECTIVE],          &benchmark_cfg[BENCHMARK_SCENARIO_PERSPECTIVE]},
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_TEXT],                 &benchmark_cfg[BENCHMARK_SCENARIO_TEXT]},
    {NULL, &benchmark_infos[BENCHMARK_SCENARIO_SCROLL_TEXT],          &benchmark_cfg[BENCHMARK_SCENARIO_SCROLL_TEXT]},
};
...
void scenario_benchmark_manager_set_scenario_count(uint8_t count)
{
    scenario_count = count;
}

bool scenario_benchmark_manager_get_first_scenario_mode(uint8_t *num)
{
    for (uint8_t i = 0; i < BENCHMARK_SCENARIO_MAX; i++)
    {
        if (benchmark_cfg[i].is_skip == false)
        {
            *num = i;
            return true;
        }
...
bool scenario_benchmark_manager_search_next_scenario(void)
{
...
int scenario_benchmark_manager_switch_next(void *parent)
{
    ...
    if (scenario_benchmark_manager_search_next_scenario() == false)
    {
        return -1;
    }

    while (((benchmark_scenarios[scenario_count].benchmark_cfg)->is_skip == true))
    {
        if (scenario_benchmark_manager_search_next_scenario() == false)
        {
            return -1;
