...
typedef enum
{
    ...
    CMD_PATH_SPI                            = 0x10,
    CMD_PATH_USB_HID                        = 0x11,

    CMD_PATH_RWS_ASYNC                      = 0x20,
    CMD_PATH_RWS_SYNC                       = 0x21,
} T_CMD_PATH;
...
//#endif
    ...
    EVENT_LE_COMMON_ADV_STATE               = 0x010D,
    ...
    EVENT_LE_AUDIO_BAAS_REQUIRE_CODE        = 0x0149,
    ...
    EVENT_FLASH_BUFFER_CHECK                = 0x031D,
    EVENT_DUMP_FLASH                        = 0x031E,
    EVENT_REPORT_DUMP_STATE                 = 0x031F,
    EVENT_FLASH_STATE_REPORT                = 0x0322,
    EVENT_FEATURE_STATE_GET_RESULT          = 0x0323,
...
//#endif
    ...
    EVENT_BLUETALKIE_NODE_JOIN_REQ          = 0x80D2,
    EVENT_BLUETALKIE_NODE_JOIN_RSP          = 0x80D3,
    EVENT_BLUETALKIE_NODE_EXIT              = 0x80D4,
    EVENT_BLUETALKIE_RECORD_DATA            = 0x80D5,
    ...
    EVENT_AI_RECORD_WIFI_QUERY_INFO             = 0x8400,
    EVENT_AI_RECORD_WIFI_POWER_DOWN             = 0x8402,
    EVENT_AI_RECORD_WIFI_GET_POWER_STATE        = 0x8403,
    EVENT_AI_RECORD_WIFI_UPDATE_PARAM           = 0x8404,
    EVENT_AI_RECORD_WIFI_SET_GPS                = 0x8405,
    EVENT_AI_RECORD_WIFI_SNAPSHOT               = 0x8406,
    EVENT_AI_RECORD_WIFI_REPORT_FILE_NAME       = 0x8407,
    EVENT_AI_RECORD_WIFI_FILE_DATA              = 0x8408,
    EVENT_AI_RECORD_WIFI_TRANS_STOP             = 0x8409,
    EVENT_AI_RECORD_WIFI_RECORD_START           = 0x840A,
    EVENT_AI_RECORD_WIFI_SYNC_TIMESTAMP         = 0x840C,
    EVENT_AI_RECORD_WIFI_RECORD_STOP            = 0x840D,
    EVENT_AI_RECORD_WIFI_GET_FILE_CNT           = 0x840E,
    EVENT_AI_RECORD_WIFI_DELETE_FILE            = 0x840F,
    EVENT_AI_RECORD_WIFI_DELETE_ALL             = 0x8410,
    EVENT_AI_RECORD_WIFI_GET_SD_INFO            = 0x8411,
    EVENT_AI_RECORD_WIFI_SET_WIFI_MODE          = 0x8412, //set wifi soc AP
    EVENT_AI_RECORD_WIFI_GET_DATA_TCP           = 0x8413,
    EVENT_AI_RECORD_WIFI_DATA_TCP_ACK           = 0x8414,
    //ai_record OTA
    EVENT_AI_RECORD_WIFI_FW_ROLLBACK            = 0x8415,
    EVENT_AI_RECORD_WIFI_SET_STA_MODE           = 0x8416, //set wifi soc STA
    EVENT_AI_RECORD_WIFI_LIVE_START             = 0x8417,
    EVENT_AI_RECORD_WIFI_LIVE_STOP              = 0x8418,
    EVENT_AI_RECORD_WIFI_RTSP_START             = 0x841A,
    EVENT_AI_RECORD_WIFI_RTSP_STOP              = 0x841B,
    EVENT_AI_RECORD_WIFI_AUDIO_START            = 0x841C,
    EVENT_AI_RECORD_WIFI_AUDIO_STOP             = 0x841D,

    EVENT_AI_RECORD_APP_QUERY_INFO              = 0x8420,
    EVENT_AI_RECORD_APP_GET_SD_INFO             = 0x8421,
    EVENT_AI_RECORD_APP_UPDATE_WIFI_INFO        = 0x8422,
    EVENT_AI_RECORD_APP_SNAPSHOT                = 0x8423,
    EVENT_AI_RECORD_APP_GET_FILE_INFO           = 0x8424,
    EVENT_AI_RECORD_APP_GET_FILE_DATA           = 0x8425,
    EVENT_AI_RECORD_APP_TRANS_STOP              = 0x8426,
    EVENT_AI_RECORD_APP_VOICE_START             = 0x8427,
    EVENT_AI_RECORD_APP_VOICE_DATA              = 0x8428,
    EVENT_AI_RECORD_APP_VOICE_STOP              = 0x8429,
    EVENT_AI_RECORD_APP_VOICE_LOCAL_COMPLETE    = 0x842A,
    EVENT_AI_RECORD_APP_UPDATE_GPS              = 0x842B,
    EVENT_AI_RECORD_APP_SET_WIFI_MODE           = 0x842C,
    EVENT_AI_RECORD_APP_GET_FILE_CNT            = 0x842D,
    EVENT_AI_RECORD_APP_GET_DATA_TCP            = 0x842E,
    EVENT_AI_RECORD_APP_DATA_TCP_ACK            = 0x842F,
    EVENT_AI_RECORD_START_SYS_UPGRADE           = 0x8430,
    EVENT_AI_RECORD_APP_SET_WIFI_STA_INFO       = 0x8436, //set wifi soc STA
    EVENT_AI_RECORD_APP_USER_KEY                = 0x8437,
    EVENT_AI_RECORD_APP_NOTIFY_ACTION_STATE     = 0x8438,
    EVENT_AI_RECORD_APP_LIVE_START_RESP         = 0x8439,
    EVENT_AI_RECORD_APP_LIVE_STOP_RESP          = 0x843A,
    EVENT_AI_RECORD_APP_LIVE_STREAM_RESP        = 0x843B,
    EVENT_AI_RECORD_APP_RTSP_START_RESP         = 0x843C,
    EVENT_AI_RECORD_APP_RTSP_STOP_RESP          = 0x843D,
#endif

#if CONFIG_REALTEK_APP_AI_AUTH
    EVENT_START_AUTH                        = 0x8432,
    EVENT_AUTH_KEY_EXCHANGE                 = 0x8433,
    EVENT_DYNAMIC_AUTH_DATA_EXCHANGE        = 0x8434,
    EVENT_ENCRYPTED_AUTH_DATA_VERIFY        = 0x8435,
#endif
