...
{
    wdg_reset_with_reason(RESET_ALL, APP_RESET_REASON_SINGLE_TONE_TIMEOUT);
}
    ...
    case AUDIO_EVENT_VOICE_PROMPT_STOPPED:
        {
            ...
            {
                wdg_reset_with_reason(RESET_ALL, APP_RESET_REASON_SINGLE_TONE_VP_STOP);
            }
        }
        break;
    ...
    case AUDIO_EVENT_RINGTONE_STOPPED:
        {
            ...
            {
                wdg_reset_with_reason(RESET_ALL, APP_RESET_REASON_SINGLE_TONE_RINGTONE_STOP);
            }
        }
        break;
                    ...
                    case MP_HCI_TEST_SINGLE_TONE:
                        {
                            single_tone_hci_cmd_vendor_cont_tx(app_cfg_nv.single_tone_channel_num,
                                                               app_cfg_nv.single_tone_tx_gain, 0);
                        }
                        break;
