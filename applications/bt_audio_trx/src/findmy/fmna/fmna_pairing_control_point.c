...
void fmna_pairing_control_point_handle_rx(void)
{
    ...
    case FMNA_SERVICE_OPCODE_INITIATE_PAIRING:
        p_fmna_initiate_pairing_data = fmna_malloc(INITIATE_PAIRING_DATA,
                                                   sizeof(fmna_initiate_pairing_data_t));
        memcpy(p_fmna_initiate_pairing_data,
    ...
    case FMNA_SERVICE_OPCODE_FINALIZE_PAIRING:
        ...
        p_fmna_finalize_pairing_data = fmna_malloc(FINALIZE_PAIRING_DATA,
                                                   sizeof(fmna_finalize_pairing_data_t));
        memcpy(p_fmna_finalize_pairing_data,
