...
{
    app_findmy_sched_event_put(NULL, 0, fmna_gatt_dispatch_send_packet_extension_indication_handler);
}
...
{
    app_findmy_sched_event_put(NULL, 0, fmna_gatt_dispatch_send_next_packet_handler);
}
#endif
