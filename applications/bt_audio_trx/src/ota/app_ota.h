...
/*ota version num*/
#define BLE_OTA_VERSION     10
#define SPP_OTA_VERSION     12
...
#ifdef DFU_LENGTH_START_DFU
#undef DFU_LENGTH_START_DFU
#endif
#if (CONFIG_SOC_SERIES_RTL87X3G == 1)
#define DFU_LENGTH_START_DFU                (1+16)
#define DATA_PADDING                        16
#else
...
#define DFU_OPCODE_CHECK_KEY                0x12
#define DFU_OPCODE_REPORT_IMAGE_NUM         0x13
...
#define IMG_ID_LEN          2
#if (CONFIG_SOC_SERIES_RTL87X3G == 1)
#define IMG_VERSION_LEN     8
#else
#define IMG_VERSION_LEN     4
#endif
#define IMG_INFO_LEN    (MAX_IMG_NUM * (IMG_ID_LEN + IMG_VERSION_LEN) + 2)
...
/**
    * @brief    used to get device information by SPP
...
/**
    * @brief    used to get device information by BLE
    * @param    p_data point to device information
    * @return   address of the device information buffer
    */
void app_ota_get_device_info_by_ble(BLE_DEVICE_INFO *p_data);
